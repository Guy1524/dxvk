...
const GUID ID3D11DeviceChild_GUID = {0x1841e5c8,0x16b0,0x489b,{0xbc,0xc8,0x44,0xcf,0xb0,0xd5,0xde,0xae}};
...
const GUID ID3D11Asynchronous_GUID = {0x4b35d0cd,0x1e15,0x4258,{0x9c,0x98,0x1b,0x13,0x33,0xf6,0xdd,0x3b}};
struct ID3D11Asynchronous : public ID3D11DeviceChild
{
    virtual UINT GetDataSize();
};

const GUID ID3D11Query_GUID = {0xd6c00747,0x87b7,0x425e,{0xb8,0x4d,0x44,0xd1,0x08,0x56,0x0a,0xfd}};
...
const GUID ID3D11Resource_GUID = {0xdc8e63f3,0xd12b,0x4952,{0xb4,0x7b,0x5e,0x45,0x02,0x6a,0x86,0x2d}};
...
const GUID ID3D11View_GUID = {0x839d1216,0xbb2e,0x412b,{0xb7,0xf4,0xa9,0xdb,0xeb,0xe0,0x8e,0xd1}};
...
const GUID ID3D11BlendState_GUID = {0x75b68faa,0x347d,0x4159,{0x8f,0x45,0xa0,0x64,0x0f,0x01,0xcd,0x9a}};
...
const GUID ID3D11Buffer_GUID = {0x48570b85,0xd1ee,0x4fcd,{0xa2,0x50,0xeb,0x35,0x07,0x22,0xb0,0x37}};
...
const GUID ID3D11ClassInstance_GUID = {0xa6cd7faa,0xb0b7,0x4a2f,{0x94,0x36,0x86,0x62,0xa6,0x57,0x97,0xcb}};
...
const GUID ID3D11ClassLinkage_GUID = {0xddf57cba,0x9543,0x46e4,{0xa1,0x2b,0xf2,0x07,0xa0,0xfe,0x7f,0xed}};
...
const GUID ID3D11CommandList_GUID = {0xa24bc4d1,0x769e,0x43f7,{0x80,0x13,0x98,0xff,0x56,0x6c,0x18,0xe2}};
struct ID3D11CommandList : public ID3D11DeviceChild
{
    virtual UINT GetContextFlags();
};

const GUID ID3D11ComputeShader_GUID = {0x4f5b196e,0xc2bd,0x495e,{0xbd,0x01,0x1f,0xde,0xd3,0x8e,0x49,0x69}};
struct ID3D11ComputeShader : public ID3D11DeviceChild
{
};

const GUID ID3D11Counter_GUID = {0x6e8c49fb,0xa371,0x4770,{0xb4,0x40,0x29,0x08,0x60,0x22,0xb7,0x41}};
...
const GUID ID3D11DepthStencilState_GUID = {0x03823efb,0x8d8f,0x4e1c,{0x9a,0xa2,0xf6,0x4b,0xb2,0xcb,0xfd,0xf1}};
...
const GUID ID3D11DepthStencilView_GUID = {0x9fdac92a,0x1876,0x48c3,{0xaf,0xad,0x25,0xb9,0x4f,0x84,0xa9,0xb6}};
...
const GUID ID3D11DomainShader_GUID = {0xf582c508,0x0f36,0x490c,{0x99,0x77,0x31,0xee,0xce,0x26,0x8c,0xfa}};
struct ID3D11DomainShader : public ID3D11DeviceChild
{
};

const GUID ID3D11GeometryShader_GUID = {0x38325b96,0xeffb,0x4022,{0xba,0x02,0x2e,0x79,0x5b,0x70,0x27,0x5c}};
struct ID3D11GeometryShader : public ID3D11DeviceChild
{
};

const GUID ID3D11HullShader_GUID = {0x8e5c6061,0x628a,0x4c8e,{0x82,0x64,0xbb,0xe4,0x5c,0xb3,0xd5,0xdd}};
struct ID3D11HullShader : public ID3D11DeviceChild
{
};

const GUID ID3D11InputLayout_GUID = {0xe4819ddc,0x4cf0,0x4025,{0xbd,0x26,0x5d,0xe8,0x2a,0x3e,0x07,0xb7}};
struct ID3D11InputLayout : public ID3D11DeviceChild
{
};

const GUID ID3D11PixelShader_GUID = {0xea82e40d,0x51dc,0x4f33,{0x93,0xd4,0xdb,0x7c,0x91,0x25,0xae,0x8c}};
struct ID3D11PixelShader : public ID3D11DeviceChild
{
};

const GUID ID3D11Predicate_GUID = {0x9eb576dd,0x9f77,0x4d86,{0x81,0xaa,0x8b,0xab,0x5f,0xe4,0x90,0xe2}};
struct ID3D11Predicate : public ID3D11Query
{
};

const GUID ID3D11RasterizerState_GUID = {0x9bb4ab81,0xab1a,0x4d8f,{0xb5,0x06,0xfc,0x04,0x20,0x0b,0x6e,0xe7}};
...
const GUID ID3D11RenderTargetView_GUID = {0xdfdba067,0x0b8d,0x4865,{0x87,0x5b,0xd7,0xb4,0x51,0x6c,0xc1,0x64}};
...
const GUID ID3D11SamplerState_GUID = {0xda6fea51,0x564c,0x4487,{0x98,0x10,0xf0,0xd0,0xf9,0xb4,0xe3,0xa5}};
...
const GUID ID3D11ShaderResourceView_GUID = {0xb0e06fe0,0x8192,0x4e1a,{0xb1,0xca,0x36,0xd7,0x41,0x47,0x10,0xb2}};
...
const GUID ID3D11Texture1D_GUID = {0xf8fb5c27,0xc6b3,0x4f75,{0xa4,0xc8,0x43,0x9a,0xf2,0xef,0x56,0x4c}};
...
const GUID ID3D11Texture2D_GUID = {0x6f15aaf2,0xd208,0x4e89,{0x9a,0xb4,0x48,0x95,0x35,0xd3,0x4f,0x9c}};
...
const GUID ID3D11Texture3D_GUID = {0x037e866e,0xf56d,0x4357,{0xa8,0xaf,0x9d,0xab,0xbe,0x6e,0x25,0x0e}};
...
const GUID ID3D11UnorderedAccessView_GUID = {0x28acf509,0x7f5c,0x48f6,{0x86,0x11,0xf3,0x16,0x01,0x0a,0x63,0x80}};
...
const GUID ID3D11VertexShader_GUID = {0x3b301d64,0xd678,0x4289,{0x88,0x97,0x22,0xf8,0x92,0x8b,0x72,0xf3}};
struct ID3D11VertexShader : public ID3D11DeviceChild
{
};

const GUID ID3D11DeviceContext_GUID = {0xc0bfa96c,0xe089,0x44fb,{0x8e,0xaf,0x26,0xf8,0x79,0x61,0x90,0xda}};
...
const GUID ID3D11AuthenticatedChannel_GUID = {0x3015a308,0xdcbd,0x47aa,{0xa7,0x47,0x19,0x24,0x86,0xd1,0x4d,0x4a}};
...
const GUID ID3D11CryptoSession_GUID = {0x9b32f9ad,0xbdcc,0x40a6,{0xa3,0x9d,0xd5,0xc8,0x65,0x84,0x57,0x20}};
...
const GUID ID3D11VideoDecoder_GUID = {0x3c9c5b51,0x995d,0x48d1,{0x9b,0x8d,0xfa,0x5c,0xae,0xde,0xd6,0x5c}};
...
const GUID ID3D11VideoProcessorEnumerator_GUID = {0x31627037,0x53ab,0x4200,{0x90,0x61,0x05,0xfa,0xa9,0xab,0x45,0xf9}};
...
const GUID ID3D11VideoProcessor_GUID = {0x1d7b0652,0x185f,0x41c6,{0x85,0xce,0x0c,0x5b,0xe3,0xd4,0xae,0x6c}};
...
const GUID ID3D11VideoDecoderOutputView_GUID = {0xc2931aea,0x2a85,0x4f20,{0x86,0x0f,0xfb,0xa1,0xfd,0x25,0x6e,0x18}};
...
const GUID ID3D11VideoProcessorInputView_GUID = {0x11ec5a5f,0x51dc,0x4945,{0xab,0x34,0x6e,0x8c,0x21,0x30,0x0e,0xa5}};
...
const GUID ID3D11VideoProcessorOutputView_GUID = {0xa048285e,0x25a9,0x4527,{0xbd,0x93,0xd6,0x8b,0x68,0xc4,0x42,0x54}};
...
const GUID ID3D11VideoDevice_GUID = {0x10ec4d5b,0x975a,0x4689,{0xb9,0xe4,0xd0,0xaa,0xc3,0x0f,0xe3,0x33}};
...
const GUID ID3D11VideoContext_GUID = {0x61f21c45,0x3c0e,0x4a74,{0x9c,0xea,0x67,0x10,0x0d,0x9a,0xd5,0xe4}};
...
const GUID ID3D11Device_GUID = {0xdb6f6ddb,0xac77,0x4e88,{0x82,0x53,0x81,0x9d,0xf9,0xbb,0xf1,0x40}};
