...
const GUID IDXGIDevice3_GUID = {0x6007896c,0x3244,0x4afd,{0xbf,0x18,0xa6,0xd3,0xbe,0xda,0x50,0x23}};
struct IDXGIDevice3 : public IDXGIDevice2
{
    virtual void Trim();
};

const GUID IDXGISwapChain2_GUID = {0xa8be2ac4,0x199f,0x4946,{0xb3,0x31,0x79,0x59,0x9f,0xb9,0x8d,0xe7}};
...
const GUID IDXGIOutput2_GUID = {0x595e39d1,0x2724,0x4663,{0x99,0xb1,0xda,0x96,0x9d,0xe2,0x83,0x64}};
struct IDXGIOutput2 : public IDXGIOutput1
{
    virtual BOOL SupportsOverlays();
};

const GUID IDXGIFactory3_GUID = {0x25483823,0xcd46,0x4c7d,{0x86,0xca,0x47,0xaa,0x95,0xb8,0x37,0xbd}};
struct IDXGIFactory3 : public IDXGIFactory2
{
    virtual UINT GetCreationFlags();
};

const GUID IDXGIOutput3_GUID = {0x8a6bb301,0x7e7e,0x41F4,{0xa8,0xe0,0x5b,0x32,0xf7,0xf9,0x9b,0x18}};
