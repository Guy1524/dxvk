#ifndef D3D10SHADER_H
#define D3D10SHADER_H
...
{
    static constexpr GUID guid = {0xc530ad7d,0x9b16,0x4395,{0xa9,0x79,0xba,0x2e,0xcf,0xf8,0x3a,0xdd}};

    virtual void                               GetDesc(D3D10_SHADER_TYPE_DESC *desc) = 0;
    virtual struct ID3D10ShaderReflectionType* GetMemberTypeByIndex(UINT index) = 0;
    virtual struct ID3D10ShaderReflectionType* GetMemberTypeByName(const char *name) = 0;
    virtual const char*                        GetMemberTypeName(UINT index) = 0;
};

struct ID3D10ShaderReflectionVariable
{
    static constexpr GUID guid = {0x1bf63c95,0x2650,0x405d,{0x99,0xc1,0x36,0x36,0xbd,0x1d,0xa0,0xa1}};

    virtual void                                GetDesc(D3D10_SHADER_VARIABLE_DESC *desc) = 0;
    virtual struct ID3D10ShaderReflectionType * GetType() = 0;
};

struct ID3D10ShaderReflectionConstantBuffer
{
    static constexpr GUID guid = {0x66c66a94,0xdddd,0x4b62,{0xa6,0x6a,0xf0,0xda,0x33,0xc2,0xb4,0xd0}};

    virtual void                                    GetDesc(D3D10_SHADER_BUFFER_DESC *desc) = 0;
    virtual struct ID3D10ShaderReflectionVariable* GetVariableByIndex(UINT index) = 0;
    virtual struct ID3D10ShaderReflectionVariable* GetVariableByName(const char *name) = 0;
};

struct ID3D10ShaderReflection : public IUnknown
{
    static constexpr GUID guid = {0xd40e20b6,0xf8f7,0x42ad,{0xab,0x20,0x4b,0xaf,0x8f,0x15,0xdf,0xaa}};
